...
class SyntaxHighlighter {
  ...
  static const _numberColor = Color(0xFFF59E0B);
  static const _commentColor = Color(0xFF6B7280);
  static const _typeColor = Color(0xFF38BDF8);
  static const _functionColor = Color(0xFFFBBF24);
  static const _operatorColor = Color(0xFFE8E8E8);
  static const _punctuationColor = Color(0xFF9CA3AF);
  static const _variableColor = Color(0xFFE6EDF3);
  static const _attributeColor = Color(0xFFA78BFA);
  static const _tagColor = Color(0xFFEF4444);
  static const _builtinColor = Color(0xFF60A5FA);
  static const _annotationColor = Color(0xFFA855F7);
  static const _plainColor = Color(0xFFE6EDF3);
    ...
    while (i < code.length) {
      ...
      for (final rule in rules) {
        ...
        if (match != null) {
          spans.add(TextSpan(
            text: match.group(0),
            style: _baseStyle.copyWith(color: rule.color),
          ));
...
class DartSyntaxHighlighter extends SyntaxHighlighter {
  ...
  TextSpan _highlight(String code) {
    final rules = [
      _TokenRule(RegExp(r'//.*'), _commentColor),
      _TokenRule(RegExp(r'/\*[\s\S]*?\*/'), _commentColor),
      _TokenRule(RegExp(r'"""[\s\S]*?"""'), _stringColor),
      _TokenRule(RegExp(r"'''[\s\S]*?'''"), _stringColor),
      _TokenRule(RegExp(r'"(?:[^"\\]|\\.)*"'), _stringColor),
      _TokenRule(RegExp(r"'(?:[^'\\]|\\.)*'"), _stringColor),
      _TokenRule(RegExp(r'r"[^"]*"|r\'[^\']*\''), _stringColor),
      _TokenRule(RegExp(r'\b(?:import|export|library|part|of|as|show|hide|abstract|class|extends|implements|mixin|with|enum|typedef|extension|on|covariant|@override|@deprecated|@required|late|final|const|var|void|int|double|num|String|bool|dynamic|Null|Object|Future|Stream|List|Set|Map|Record|never|throw|rethrow|try|catch|on|finally|return|break|continue|if|else|for|while|do|switch|case|default|assert|async|await|yield|sync|static|external|factory|get|set|operator|new|this|super|true|false|null|is|is!|as|in)\b'), _keywordColor),
      _TokenRule(RegExp(r'\b(?:print|printError|printToConsole|identical|identityHashCode|identical|runtimeType|hashCode|toString|noSuchMethod|runtimeType)\b'), _builtinColor),
      _TokenRule(RegExp(r'\b0[xX][0-9a-fA-F]+\b'), _numberColor),
      _TokenRule(RegExp(r'\b\d+\.?\d*(?:[eE][+-]?\d+)?\b'), _numberColor),
      _TokenRule(RegExp(r'@\w+'), _annotationColor),
      _TokenRule(RegExp(r'\b[A-Z][a-zA-Z0-9]*\b'), _typeColor),
      _TokenRule(RegExp(r'\b[a-z_]\w*(?=\s*\()'), _functionColor),
...
class PythonSyntaxHighlighter extends SyntaxHighlighter {
  ...
  TextSpan _highlight(String code) {
    final rules = [
      ...
      _TokenRule(RegExp(r'"""[\s\S]*?"""'), _stringColor),
      _TokenRule(RegExp(r"'''[\s\S]*?'''"), _stringColor),
      _TokenRule(RegExp(r'[fF]?(?:"(?:[^"\\]|\\.)*"|\'(?:[^\'\\]|\\.)*\')'), _stringColor),
      _TokenRule(RegExp(r'\b(?:def|class|if|elif|else|for|while|try|except|finally|with|as|import|from|pass|break|continue|return|yield|lambda|and|or|not|is|in|True|False|None|raise|async|await|global|nonlocal|del|assert|self|super)\b'), _keywordColor),
      _TokenRule(RegExp(r'\b(?:print|len|range|int|str|float|list|dict|set|tuple|bool|open|sorted|enumerate|zip|map|filter|type|isinstance|hasattr|getattr|setattr|super|object|staticmethod|classmethod|property)\b'), _builtinColor),
      _TokenRule(RegExp(r'\b0[xX][0-9a-fA-F]+\b'), _numberColor),
      _TokenRule(RegExp(r'\b\d+\.?\d*(?:[eE][+-]?\d+)?\b'), _numberColor),
      _TokenRule(RegExp(r'@\w+'), _annotationColor),
      _TokenRule(RegExp(r'\b[A-Z][a-zA-Z0-9]*\b'), _typeColor),
...
class JavaScriptSyntaxHighlighter extends SyntaxHighlighter {
  ...
  TextSpan _highlight(String code) {
    final rules = [
      ...
      _TokenRule(RegExp(r'"(?:[^"\\]|\\.)*"'), _stringColor),
      _TokenRule(RegExp(r"'(?:[^'\\]|\\.)*'"), _stringColor),
      _TokenRule(RegExp(r'\b(?:const|let|var|function|class|extends|implements|interface|type|enum|import|export|from|default|async|await|yield|return|if|else|for|while|do|switch|case|break|continue|try|catch|finally|throw|new|this|super|typeof|instanceof|void|delete|in|of|true|false|null|undefined|NaN)\b'), _keywordColor),
      _TokenRule(RegExp(r'\b(?:console|Math|JSON|Promise|Array|Object|String|Number|Boolean|Map|Set|Symbol|Date|RegExp|Error|setTimeout|setInterval|fetch|document|window|module|require|process)\b'), _builtinColor),
      _TokenRule(RegExp(r'\b0[xX][0-9a-fA-F]+\b'), _numberColor),
      _TokenRule(RegExp(r'\b\d+\.?\d*(?:[eE][+-]?\d+)?\b'), _numberColor),
      _TokenRule(RegExp(r'\b[A-Z][a-zA-Z0-9]*\b'), _typeColor),
      _TokenRule(RegExp(r'\b[a-z_$]\w*(?=\s*\()'), _functionColor),
...
class JavaSyntaxHighlighter extends SyntaxHighlighter {
  ...
  TextSpan _highlight(String code) {
    final rules = [
      ...
      _TokenRule(RegExp(r'"(?:[^"\\]|\\.)*"'), _stringColor),
      _TokenRule(RegExp(r"'(?:[^'\\]|\\.)'"), _stringColor),
      _TokenRule(RegExp(r'\b(?:public|private|protected|static|final|abstract|class|interface|extends|implements|enum|import|package|void|int|long|double|float|boolean|char|byte|short|null|true|false|if|else|for|while|do|switch|case|break|continue|return|throw|throws|try|catch|finally|new|this|super|synchronized|volatile|transient|native|strictfp|assert|default|instanceof|var|record|sealed|permits)\b'), _keywordColor),
      _TokenRule(RegExp(r'@\w+'), _annotationColor),
      _TokenRule(RegExp(r'\b[A-Z][a-zA-Z0-9]*\b'), _typeColor),
      _TokenRule(RegExp(r'\b[a-z_]\w*(?=\s*\()'), _functionColor),
      _TokenRule(RegExp(r'\b0[xX][0-9a-fA-F]+\b'), _numberColor),
      _TokenRule(RegExp(r'\b\d+\.?\d*(?:[eE][+-]?\d+)?[fFdD]?\b'), _numberColor),
      _TokenRule(RegExp(r'=>|[+\-*/%&|^~<>!?=]+'), _operatorColor),
      _TokenRule(RegExp(r'[{}[\]();.,:]'), _punctuationColor),
    ];
    final spans = _tokenize(code, rules);
...
class RustSyntaxHighlighter extends SyntaxHighlighter {
  ...
  TextSpan _highlight(String code) {
    final rules = [
      _TokenRule(RegExp(r'//.*'), _commentColor),
      _TokenRule(RegExp(r'/\*[\s\S]*?\*/'), _commentColor),
      _TokenRule(RegExp(r'r#?"(?:[^"\\]|\\.)*"'), _stringColor),
      _TokenRule(RegExp(r"'(?:[^'\\]|\\.)'"), _stringColor),
      ...
      _TokenRule(RegExp(r'#!?\[.*?\]'), _annotationColor),
      _TokenRule(RegExp(r'\b[A-Z][a-zA-Z0-9]*\b'), _typeColor),
      _TokenRule(RegExp(r'\b[a-z_]\w*(?=\s*\()'), _functionColor),
      _TokenRule(RegExp(r'\b0[xXoObB][0-9a-fA-F]+\b'), _numberColor),
      _TokenRule(RegExp(r'\b\d+\.?\d*(?:[eE][+-]?\d+)?\b'), _numberColor),
      _TokenRule(RegExp(r'=>|[+\-*/%&|^~<>!?=]+'), _operatorColor),
      _TokenRule(RegExp(r'[{}[\]();.,:]'), _punctuationColor),
    ];
...
class HtmlSyntaxHighlighter extends SyntaxHighlighter {
  ...
  TextSpan _highlight(String code) {
    final rules = [
      _TokenRule(RegExp(r'<!--[\s\S]*?-->'), _commentColor),
      _TokenRule(RegExp(r'<[a-zA-Z][a-zA-Z0-9]*'), _tagColor),
      _TokenRule(RegExp(r'</[a-zA-Z][a-zA-Z0-9]*>'), _tagColor),
      _TokenRule(RegExp(r'/>'), _tagColor),
      _TokenRule(RegExp(r'\b[a-zA-Z-]+(?=\s*=)'), _attributeColor),
      _TokenRule(RegExp(r'"(?:[^"\\]|\\.)*"'), _stringColor),
      _TokenRule(RegExp(r"'(?:[^'\\]|\\.)*'"), _stringColor),
      _TokenRule(RegExp(r'[{}]'), _punctuationColor),
    ];
...
class CssSyntaxHighlighter extends SyntaxHighlighter {
  ...
  TextSpan _highlight(String code) {
    final rules = [
      ...
      _TokenRule(RegExp(r'"(?:[^"\\]|\\.)*"'), _stringColor),
      _TokenRule(RegExp(r"'(?:[^'\\]|\\.)*'"), _stringColor),
      _TokenRule(RegExp(r'#[0-9a-fA-F]{3,8}\b'), _numberColor),
      _TokenRule(RegExp(r'\b\d+\.?\d*(?:px|em|rem|vh|vw|%|s|ms)?\b'), _numberColor),
      _TokenRule(RegExp(r'(?:https?:\/\/[^\s;)]+)'), _stringColor),
      _TokenRule(RegExp(r'[.#]?[a-zA-Z][a-zA-Z0-9_-]*(?=\s*{)'), _tagColor),
      _TokenRule(RegExp(r'\b[a-zA-Z-]+(?=\s*:)'), _attributeColor),
      _TokenRule(RegExp(r'[{};:]'), _punctuationColor),
    ];
    final spans = _tokenize(code, rules);
...
class JsonSyntaxHighlighter extends SyntaxHighlighter {
  ...
  TextSpan _highlight(String code) {
    final rules = [
      _TokenRule(RegExp(r'"(?:[^"\\]|\\.)*"(?=\s*:)'), _attributeColor),
      _TokenRule(RegExp(r'"(?:[^"\\]|\\.)*"'), _stringColor),
      _TokenRule(RegExp(r'\b(?:true|false|null)\b'), _keywordColor),
      _TokenRule(RegExp(r'\b-?\d+\.?\d*(?:[eE][+-]?\d+)?\b'), _numberColor),
      _TokenRule(RegExp(r'[{}[\]],:'), _punctuationColor),
    ];
    final spans = _tokenize(code, rules);
...
class YamlSyntaxHighlighter extends SyntaxHighlighter {
  ...
  TextSpan _highlight(String code) {
    final rules = [
      ...
      _TokenRule(RegExp(r'"(?:[^"\\]|\\.)*"'), _stringColor),
      _TokenRule(RegExp(r"'(?:[^'\\]|\\.)*'"), _stringColor),
      _TokenRule(RegExp(r'^[a-zA-Z][a-zA-Z0-9_]*(\s*):', multiLine: true), _attributeColor),
      _TokenRule(RegExp(r'^\s*[a-zA-Z][a-zA-Z0-9_]*(\s*):', multiLine: true), _attributeColor),
      _TokenRule(RegExp(r'\b(?:true|false|yes|no|on|off|null)\b'), _keywordColor),
      _TokenRule(RegExp(r'\b\d+\.?\d*\b'), _numberColor),
      _TokenRule(RegExp(r'[{}[\]],:-'), _punctuationColor),
    ];
    final spans = _tokenize(code, rules);
    return TextSpan(children: spans, style: _baseStyle);
...
class MarkdownSyntaxHighlighter extends SyntaxHighlighter {
  ...
  TextSpan _highlight(String code) {
    final rules = [
      _TokenRule(RegExp(r'^#{1,6}\s.*', multiLine: true), _keywordColor),
      _TokenRule(RegExp(r'\*\*.*?\*\*'), _keywordColor),
      _TokenRule(RegExp(r'__.*?__'), _keywordColor),
      _TokenRule(RegExp(r'\*.*?\*'), _functionColor),
      _TokenRule(RegExp(r'_.*?_'), _functionColor),
      _TokenRule(RegExp(r'`[^`]+`'), _stringColor),
      _TokenRule(RegExp(r'```[\s\S]*?```'), _stringColor),
      _TokenRule(RegExp(r'!?\[.*?\]\(.*?\)'), _tagColor),
      _TokenRule(RegExp(r'^[-*+]\s', multiLine: true), _punctuationColor),
      _TokenRule(RegExp(r'^\d+\.\s', multiLine: true), _numberColor),
      _TokenRule(RegExp(r'^>\s', multiLine: true), _commentColor),
      _TokenRule(RegExp(r'^---+', multiLine: true), _punctuationColor),
    ];
    final spans = _tokenize(code, rules);
    return TextSpan(children: spans, style: _baseStyle);
  }
